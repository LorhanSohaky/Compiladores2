...
Uma aresta *a ∈ A* de corte se *G - a* é desconexo, ou seja, a remoção de uma aresta-de-corte desconecta o grafo. Um vértice * v * é  considerado um vértice de corte se e somente se *v* tem um filho *t* tal que ∄ aresta ligando qualquer descendente de *t* a um ancestral de *v* [@cormen].
...
2. Para cada vértice *v ∈ DFS* verificar se *∄ (a,v)* na *BFS*,  nesse caso o vértice *w*, que é o ancestral de *v* na *DFS* passará a ser o novo ancestral em comum, a aresta *(w,v)* passa a ser de corte e os vértices *w* e *v* são marcados como de corte.
...
Sendo *π* uma função de permutação e *v* um vértice qualquer do grafo:
- se *π(v) < v* o vértice *v* é chamado de positivo;
- se *π(v) = v* o vértice *v* é chamado de neutro;
- se *π(v) > v* o vértice *v* é chamado de negativo.
...
2. existe um vértice *u* < *i* e que *π(u)=i*.
